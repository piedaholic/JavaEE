...
public class EjbUtils {
   ...
   */
  public EJBLocalHome getEJBLocalHome(String jndiName, InitialContext initialContext, Map<String, EJBLocalHome> cache) {
   ...
   */
  public DataSource getDataSource(String dataSourceName, InitialContext initialContext, Map<String, DataSource> cache) {
