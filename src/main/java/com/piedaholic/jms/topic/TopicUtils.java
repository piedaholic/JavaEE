package com.piedaholic.jms.topic;
...
public class TopicUtils {
   ...
   * @param p_JMS_TOPIC_SECURITY_CREDENTIALS the p JM S TOPI C SECURIT Y
   *                                         CREDENTIALS
   ...
   */
  public void publishMsg(String p_msg, String p_correlationID, String p_JMS_TOPIC_ICF, String p_JMS_TOPIC_PROVIDER_URL,
      String p_JMS_TOPIC_SECURITY_PRINCIPAL, String p_JMS_TOPIC_SECURITY_CREDENTIALS, String p_JMS_TCF,
      String p_topic_name, boolean p_transacted, boolean l_within_container) throws Exception {
    if (p_transacted) {
